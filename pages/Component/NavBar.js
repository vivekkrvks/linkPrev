          ...
          <div className="navbar-collapse relative flex collapse grow items-center" id="navbarSupportedContentY">
            ...
            <ul className="navbar-nav mr-auto flex lg:flex lg:flex-row">
              <li className="nav-item">
                <a className="nav-link block pr-2 lg:px-2 py-2 hover:text-[#2D88E2] focus:text-[#2D88E2] transition duration-150 ease-in-out"  onClick={() => router.push(`/`)} data-mdb-ripple="true" data-mdb-ripple-color="light">Qualifier</a>
              </li>
              <li className="nav-item">
